...
@Singleton
@Unremovable
public class UpdateGuardedBranches implements StepHandler {
    ...
    public boolean shouldSkip(ReleaseInformation releaseInformation, ReleaseStatus releaseStatus) {
        return !releaseInformation.isFirstFinal() || !Branches.isLts(releaseInformation.getBranch());
    }
    ...
    public StepResult run(Context context, Commands commands, GitHub quarkusBotGitHub, ReleaseInformation releaseInformation,
        ...
        return StepResult.of(processes.execute(List.of("./update-guarded-branches.sh")));
    }
}
