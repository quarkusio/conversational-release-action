...
@Singleton
@Unremovable
public class UpdateWikiMigrationGuidesFinal implements StepHandler {
    ...
    public StepResult run(Context context, Commands commands, GitHub quarkusBotGitHub, ReleaseInformation releaseInformation,
        ...
        return StepResult.of(processes.execute(List.of("./update-wiki-migration-guides-final.sh")));
    }
}
