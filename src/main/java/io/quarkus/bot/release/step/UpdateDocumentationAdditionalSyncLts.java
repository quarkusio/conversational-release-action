...
@Singleton
@Unremovable
public class UpdateDocumentationAdditionalSyncLts implements StepHandler {
    ...
    public StepResult run(Context context, Commands commands, GitHub quarkusBotGitHub, ReleaseInformation releaseInformation,
        ...
        return StepResult.of(processes.execute(List.of("./update-docs.sh", releaseInformation.getBranch())));
    }
